...
#agent = Sarsa((tuple([s.n for s in env.observation_space]), env.action_space.n),
...
#agent = DynaQ((tuple([s.n for s in env.observation_space]), env.action_space.n), n=10,
#agent = HQL((tuple([s.n for s in env.observation_space]), env.action_space.n),
#            explo_horizon=1, learn_rate=0.05, gamma=0.9)
agent = Sarsa(**d)
